...
const ContactButtons = ({ className = '', showPhoneNumber = true }: ContactButtonsProps) => {
  const phoneNumber = '+919400978436';
  const whatsappNumber = '+919400978436';
  const address = 'Near Amrita Engineering College, Vallikavu, Amritapuri, Karunagapally, Kollam - 690525';
